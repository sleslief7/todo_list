...
defaultInbox.addEventListener("click", () => {
  (0,_updateDisplay_js__WEBPACK_IMPORTED_MODULE_2__.setCurrentTab)("Inbox");
  (0,_updateDisplay_js__WEBPACK_IMPORTED_MODULE_2__.refresh)();
});

defaultToday.addEventListener("click", () => {
  (0,_updateDisplay_js__WEBPACK_IMPORTED_MODULE_2__.setCurrentTab)(null);
  (0,_updateDisplay_js__WEBPACK_IMPORTED_MODULE_2__.refresh)();
});
...
function getStorageItem(item, defaultVal = []) {
...
const saveTaskBtn = document.getElementById("save-task");
const saveProjectBtn = document.getElementById("save-project");
let currentTab = (0,_state_js__WEBPACK_IMPORTED_MODULE_2__.getStorageItem)("currentTab", "Inbox");
...
function refreshTasks(toDisplay) {
  ...
  for (let i = 0; i < _state_js__WEBPACK_IMPORTED_MODULE_2__.tasks.length; i++) {
    if (_state_js__WEBPACK_IMPORTED_MODULE_2__.tasks[i].taskProject !== currentTab && currentTab) continue;
...
function todaysFilter(t) {
  return t.taskDueDate === (0,date_fns__WEBPACK_IMPORTED_MODULE_3__.format)(new Date(), "yyyy/MM/dd");
}
