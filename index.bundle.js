...
projectListItems.forEach((item) => {
  item.addEventListener("click", (e) => {
    let index = (0,_updateDisplay_js__WEBPACK_IMPORTED_MODULE_2__.grabIndex)(e);
    updateProjectTitleDisplay(_state_js__WEBPACK_IMPORTED_MODULE_1__.projects[index].projectTitle);
  });
});
